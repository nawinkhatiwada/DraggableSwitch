...
public class DraggableSwitch extends CompoundButton {
    ...
    public DraggableSwitch(Context context, AttributeSet attrs) {
        this(context, attrs,R.attr.draggableSwitchStyleAttr);
    }

    public DraggableSwitch(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.DraggableSwitch, defStyle, 0);
        mLeftBackground = a.getDrawable(R.styleable.DraggableSwitch_leftBackground);
        mRightBackground = a.getDrawable(R.styleable.DraggableSwitch_rightBackground);
        mOrientation = a.getInteger(R.styleable.DraggableSwitch_orientation, HORIZONTAL);
        mThumbDrawable = a.getDrawable(R.styleable.DraggableSwitch_thumb);
        mTrackDrawable = a.getDrawable(R.styleable.DraggableSwitch_track);
        mTextOn = a.getText(R.styleable.DraggableSwitch_textOn);
        mTextOff = a.getText(R.styleable.DraggableSwitch_textOff);
        //mShowText = a.getBoolean(com.android.internal.R.styleable.Switch_showText, true);
        mDrawableOn = a.getDrawable(R.styleable.DraggableSwitch_drawableOn);
        mDrawableOff = a.getDrawable(R.styleable.DraggableSwitch_drawableOff);

        mPushStyle = a.getBoolean(R.styleable.DraggableSwitch_pushStyle, false);

        mTextOnThumb = a.getBoolean(R.styleable.DraggableSwitch_textOnThumb, true);
        mThumbExtraMovement = a.getDimensionPixelSize(R.styleable.DraggableSwitch_thumbExtraMovement, 0);
        mThumbTextPadding = a.getDimensionPixelSize(R.styleable.DraggableSwitch_thumbTextPadding, (int) (5 * density));
        mTrackTextPadding = a.getDimensionPixelSize(R.styleable.DraggableSwitch_trackTextPadding, (int) (5 * density));

        mSwitchMinWidth = a.getDimensionPixelSize(R.styleable.DraggableSwitch_switchMinWidth, (int) (60 * density));
        mSwitchMinHeight = a.getDimensionPixelSize(R.styleable.DraggableSwitch_switchMinHeight, 0);
        mSwitchPadding = a.getDimensionPixelSize(R.styleable.DraggableSwitch_switchPadding, 0);
        ...
        mMaskDrawable = a.getDrawable(R.styleable.DraggableSwitch_backgroundMask);
        ...
        int appearance = a.getResourceId(R.styleable.DraggableSwitch_draggableTextAppearanceAttr, 0);
        if (appearance != 0) {
    ...
    public void setSwitchTextAppearance(Context context, int resId) {
        TypedArray appearance =
                context.obtainStyledAttributes(resId, R.styleable.draggableTextAppearanceAttr);

        ColorStateList colors;
        int ts;

        colors = appearance.getColorStateList(R.styleable.draggableTextAppearanceAttr_textColor);
        if (colors != null) {
            mTextColors = colors;
        } else {
        ...
        ts = appearance.getDimensionPixelSize(R.styleable.draggableTextAppearanceAttr_textSize, 0);
        if (ts != 0) {
        ...
        typefaceIndex = appearance.getInt(R.styleable.draggableTextAppearanceAttr_typeface, -1);
        styleIndex = appearance.getInt(R.styleable.draggableTextAppearanceAttr_textStyle, -1);
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        */
        ...
        if (mMaskDrawable != null) {
            tempBitmap = Bitmap.createBitmap(mSwitchRight - mSwitchLeft, mSwitchBottom - mSwitchTop, Bitmap.Config.ARGB_8888);
            ...
            maskBitmap = Bitmap.createBitmap(mSwitchRight - mSwitchLeft, mSwitchBottom - mSwitchTop, Bitmap.Config.ARGB_8888);
